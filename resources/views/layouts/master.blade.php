...
<head>
  ...
  <link href="{{asset('css/prismjs.bundle.css?v=7.0.6')}}" rel="stylesheet" type="text/css"/>
  ...
  <script src="https://use.fontawesome.com/8cb3ef66a6.js"></script>
...
<div class="d-flex flex-column flex-root">
  ...
  <div class="d-flex flex-row flex-column-fluid page">
    ...
    <div class="aside aside-left  d-flex flex-column flex-row-auto" id="kt_aside">
      ...
      <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <li class="menu-item " aria-haspopup="true" >
          <a target="_blank" href="https://preview.keenthemes.com/metronic/preview/demo5/builder.html" class="menu-link ">
            <span class="svg-icon menu-icon">
          ...
          <span class="menu-text">ACQUISITION</span>
        </a>
      </li>

      @if(auth()->user()->is_admin == 1)
      <li class="menu-item " aria-haspopup="true" >
        <a target="_blank" href="{{ url('vendor_requests') }}" class="menu-link ">
          <span class="svg-icon menu-icon">
            <!--begin::Svg Icon | path:assets/media/svg/icons/Home/Library.svg-->
            <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <span class="menu-text">VENDOR APPROVAL REQUEST</span>
      </a>
    </li>
    ...
    <li class="menu-item " aria-haspopup="true" >
      <a target="_blank" href="{{ url('vendor_add_admin') }}" class="menu-link ">
        <span class="svg-icon menu-icon">
          <!--begin::Svg Icon | path:assets/media/svg/icons/Home/Library.svg-->
          <svg
          xmlns="http://www.w3.org/2000/svg"
      ...
      <span class="menu-text">VENDOR ADD ADMIN</span>
    </a>
  </li>
  @endif
  ...
  <li class="menu-item " aria-haspopup="true" >
    <a target="_blank" href="{{ url('vendor_order') }}" class="menu-link ">
      <span class="svg-icon menu-icon">
        <!--begin::Svg Icon | path:assets/media/svg/icons/Home/Library.svg-->
        <svg
        xmlns="http://www.w3.org/2000/svg"
    ...
    <span class="menu-text">VENDOR ADD REQUEST</span>
  </a>
</li>
@endif
...
<?php 
          ...
          <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
            ...
            <div id="kt_header" class="header  header-fixed " >
              ...
              <div class=" container  d-flex align-items-stretch justify-content-between">
                ...
                <!--end::Aside Toggle-->
                <!--begin::Logo-->
                <a href="{{url('home')}}" class="custom-logo-cls">
                  BAYT al-Hikmah
   ...
   @if(auth()->user()->is_admin == 0)
   <div class="topbar-item mr-4">
    <a class="dropdown-item" href="{{ route('vendor_reset_password') }}" style="text-decoration: none; background-color: inherit; padding: 0 !important;">
      <div class="btn font-weight-bolder btn-sm btn-light-success px-5">
        Change Password
      </div>
    </a>
  ...
  <div class="topbar-item mr-4">
    <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" style="text-decoration: none; background-color: inherit; padding: 0 !important;">
      <div class="btn font-weight-bolder btn-sm btn-light-success px-5">
        Logout
      </div>
    </a>
...
<script src="{{asset('js/prismjs.bundle.js?v=7.0.6')}}"></script>
<script src="{{asset('js/scripts.bundle.js?v=7.0.6')}}"></script>
<!--end::Global Theme Bundle-->
<!--begin::Page Vendors(used by this page)-->
<script src="{{asset('js/fullcalendar.bundle.js?v=7.0.6')}}"></script>
<!--end::Page Vendors-->
<!--begin::Page Scripts(used by this page)-->
<script src="{{asset('js/widgets.js?v=7.0.6')}}"></script>
{{-- 
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script> --}}
  <script src="{{asset('assets/js/pages/crud/forms/validation/form-controls.js?v=7.0.6')}}"></script>
  <!--end::Page Scripts-->
  <!--begin::Page Vendors(used by this page)-->
  {{-- <script src="{{asset('assets/plugins/custom/datatables/datatables.bundle.js?v=7.0.6')}}"></script> --}}
  <!--end::Page Vendors-->
  <!--begin::Page Scripts(used by this page)-->
  {{-- <script src="{{asset('assets/js/pages/crud/datatables/basic/basic.js?v=7.0.6')}}"></script> --}}
<script>
